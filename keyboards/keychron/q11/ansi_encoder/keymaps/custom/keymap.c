...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_91_ansi(
        /*
        * Sensible defaults for my use case:
        * Tilde key is now QK_GESC (I've swapped the keys on the board)
        * ESC key is now KC_GRV, which I use specifically for backticks
        * The capslock is now sending KC_LCTL
        * FN, KC_LCT, KC_LOPTN, and KC_LCMMD have wrapped around and shifted to the right
        */
        KC_MUTE,  KC_GRV,     KC_BRID,  KC_BRIU,  KC_MCTL,  KC_LPAD,  RGB_VAD,   RGB_VAI,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,    KC_VOLU,  KC_INS,   KC_DEL,   KC_MUTE,
        MC_1,     QK_GESC,    KC_2,     KC_2,     KC_3,     KC_4,     KC_5,      KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,    KC_EQL,   KC_BSPC,            KC_PGUP,
        ...
        MC_5,     MO(MAC_FN), KC_LCTL,  KC_LOPTN, KC_LCMMD,          KC_SPC,                        KC_SPC,             KC_RCMMD, MO(MAC_FN), KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),


    [MAC_FN] = LAYOUT_91_ansi(
        // QK_BOOT keys added to the far left and right
        ...
        QK_BOOT,  _______,  _______,  _______,  _______,            _______,                       _______,            _______,  _______,    _______,  _______,  _______,  QK_BOOT),
